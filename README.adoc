...
image:https://mirrors.creativecommons.org/presskit/icons/cc.svg?ref=chooser-v1[CC, width=40, height=40]
image:https://mirrors.creativecommons.org/presskit/icons/by.svg?ref=chooser-v1[BY, width=40, height=40]
image:https://mirrors.creativecommons.org/presskit/icons/sa.svg?ref=chooser-v1[SA, width=40, height=40]
