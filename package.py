...
#
# A tip of the hat to Espressif
# https://github.com/espressif/kicad-libraries/blob/main/package.py
#
...
ZIP_FILE_NAME = "cmh-kicad-library-addon.zip"
DOWNLOAD_URL = "https://github.com/cmhettinger/cmh-kicad-library/releases/download/{VERSION}/{ZIP_FILE_NAME}"
...
def package():
    ...
    print('All necessary files are generated.')
